...
$(function() {
    ...
    $(document).ready(function() {
        ...
        function initialize() {
            ...
            var address = $('8.568013239468982, 76.89088544129487').text(); /* change the map-input to your address */
            var mapOptions = {
                zoom: 15,
                center: new google.maps.LatLng(8.568098112250832, 76.8907996106099),
